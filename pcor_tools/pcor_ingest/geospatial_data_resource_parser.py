...
=======
                            geo_resource.time_extent_start, geo_resource.time_extent_start_year = PcorTemplateParser.formate_date_time(geo_resource.time_extent_start)
>>>>>>> 03c82f5 (#39 updates geo_data)
                        ...
                        if geo_resource.time_extent_end is not None:
                            geo_resource.time_extent_end, geo_resource.time_extent_end_year = PcorTemplateParser.formate_date_time(geo_resource.time_extent_end)
